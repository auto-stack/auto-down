...
└── front/
    ...
    └── e2e/                # playwright specs (22, dual-backend)
```
...
| Status | primary (e2e 22/22, dual-backend) | plan-022 Phase 4/5: core flows verified |
...
pnpm test:e2e       # playwright, 22 specs
JADE_GARDEN_SERVER=vm pnpm test:e2e   # same 22 specs on the VM backend
```
