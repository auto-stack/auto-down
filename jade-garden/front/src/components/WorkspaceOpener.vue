    ...
    <div class="flex h-full items-center justify-center bg-background p-6">
      <div class="w-full max-w-md rounded-xl border bg-card p-8 shadow-sm">
        ...
        <div class="flex gap-2">
          ...
          <input class="flex-1 rounded-lg border bg-background px-3 py-2 text-sm outline-none ring-primary/30 transition-shadow focus:ring-2" :type="'text'" v-model="path" :placeholder="'粘贴完整目录路径，例如 D:\\\\wiki\\\\demo'" @keydown.enter="Open" @input="PathInput($event)" />
